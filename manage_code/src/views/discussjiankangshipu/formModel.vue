				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="UserName" prop="nickname">
							<el-input class="list_inp" v-model="form.nickname" placeholder="UserName"
                                type="text"
								readonly />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="Comment content" prop="content">
                            <editor :value="form.content||''" placeholder="Please enter the comment content" :readonly="true"
                                    class="list_editor" @change="(e)=>editorChange(e,'content')"></editor>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="Reply content" prop="reply">
                            <editor :value="form.reply||''" placeholder="Please enter the reply content"
...
<script setup>
	...
	const save= async ()=>{
		if(form.value.reply==""){
			context.$toolUtil.message("The reply content cannot be empty","error")
			return
		}
