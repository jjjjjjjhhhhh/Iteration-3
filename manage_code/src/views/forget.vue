	...
	<div>
		<div class="forget_view">
			<el-form :model="forgetForm" class="forget_box">
				<div class="forget_title">Family Health and Life Management System for Obese Population{{pageType==1?'Enter account':pageType==2?'Enter security':'reset password'}}</div>
				<div class="tab_view">
					<div class="tab" :class="pageType==1?'tab_active':''">Enter account</div>
					<div class="tab" :class="pageType==2?'tab_active tab_active1':''"> Enter security</div>
					<div class="tab" :class="pageType==3?'tab_active tab_active1 tab_active2':''">reset password</div>
				</div>
			</el-form>
		</div>
	</div>
...
.forget_view .forget_box{ width:600px; height:100%; margin:0 10% 0 0;  padding:30px 50px 40px 50px; background:#fff; font-size:16px; border-radius:20px; transform:scale(1); -webkit-transform:scale(1); -ms-transform:scale(1); z-index:5;  box-shadow: 0px 10px 13px -7px #000000, 5px 5px 15px 5px rgba(0,0,0,0);border: 1px solid #ddd;  border-radius:10px;  position: relative;
}
.forget_view .forget_box::after,.forget_view .forget_box::before {
...
.forget_view .list_btn .get_btn{ width: 100%; height: 42px; line-height: 42px; background: var(--theme); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .get_btn:hover {  } 

.forget_view .list_btn .valid_btn{  width: 100%; height: 42px; line-height: 42px; background: var(--theme); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
.forget_view .list_btn .valid_btn:hover {  } 

.forget_view .list_btn .update_btn{  width: 100%; height: 42px; line-height: 42px; background: var(--theme); border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px;  padding:0 20px; border-radius:0px; min-width:120px;  float:left;  } 
