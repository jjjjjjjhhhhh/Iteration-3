				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="User ID" prop="uid">
							<el-input class="list_inp" v-model="form.uid" placeholder="User ID"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Content" prop="content">
							<el-input class="list_inp" v-model="form.content" placeholder="Content"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Format (1: Text, 2: Images)" prop="format">
							<el-input class="list_inp" v-model.number="form.format" placeholder="Format (1: Text, 2: Images)"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Message read (0: unread, 1: read)" prop="isRead">
							<el-input class="list_inp" v-model.number="form.isRead" placeholder="Message read (0: unread, 1: read)"
                                type="text"
