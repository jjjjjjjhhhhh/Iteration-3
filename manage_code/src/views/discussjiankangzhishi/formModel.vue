				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="User name" prop="nickname">
							<el-input class="list_inp" v-model="form.nickname" placeholder="User name"
                                type="text"
								readonly />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="Comment content" prop="content">
                            <editor :value="form.content||''" placeholder="EnterComment content" :readonly="true"
                                    class="list_editor" @change="(e)=>editorChange(e,'content')"></editor>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="Reply content" prop="reply">
                            <editor :value="form.reply||''" placeholder="EnterReply content"
