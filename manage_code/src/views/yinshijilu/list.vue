	...
	<div>
		<div class="center_view">
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('yinshijilu','新增')">
						<i class="iconfont icon-xinzeng4"></i>
						Add
					</el-button>
					<el-button class="del_btn" type="danger" :disabled="selRows.length?false:true" @click="delClick(null)"  v-if="btnAuth('yinshijilu','删除')">
			...
			<el-table
				...
				<el-table-column label="operate" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="view_btn" type="info" v-if=" btnAuth('yinshijilu','查看')" @click="infoClick(scope.row.id)">
							<i class="iconfont icon-sousuo5"></i>
							View
						</el-button>
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('yinshijilu','修改')">
							<i class="iconfont icon-xiugai5"></i>
							Edit						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)"  v-if="btnAuth('yinshijilu','删除')">
							<i class="iconfont icon-shanchu4"></i>
							Delete						</el-button>
					</template>
				</el-table-column>
...
<script setup>
	...
	const tableName = 'yinshijilu'
	const formName = 'Food record'
