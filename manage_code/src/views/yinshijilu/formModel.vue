		...
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					...
					<el-col :span="24">
						<el-form-item label="Dietary Details" prop="yinshixiangqing">
							<editor :value="form.yinshixiangqing" placeholder="Enter Dietary Details" :readonly="!isAdd||disabledForm.yinshixiangqing?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'yinshixiangqing')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.yinshixiangqing = res.data.data.yinshixiangqing?(res.data.data.yinshixiangqing.replace(reg,'../../../cl0184941100/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='yinshixiangqing'){
					form.value.yinshixiangqing = row[x];
					disabledForm.value.yinshixiangqing = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
