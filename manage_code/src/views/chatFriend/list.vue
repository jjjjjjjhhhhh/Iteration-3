	...
	<div>
		<div class="center_view">
			...
			<el-table
				...
				<el-table-column label="Picture" min-width="140" width="120" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
				...
				<el-table-column min-width="140"
					...
					header-align="left"
					prop="type"
					label="type (0: friend request, 1: friend, 2: message)">
					<template #default="scope">
						{{scope.row.type}}
					</template>
				</el-table-column>
