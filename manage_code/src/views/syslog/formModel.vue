				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="Username" prop="username">
							<el-input class="list_inp" v-model="form.username" placeholder="UserName"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="User operate" prop="operation">
							<el-input class="list_inp" v-model="form.operation" placeholder="User operate"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Request method" prop="method">
							<el-input class="list_inp" v-model="form.method" placeholder="Request method"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Request duration (milliseconds)" prop="time">
							<el-input class="list_inp" v-model="form.time" placeholder="Request duration (milliseconds)"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="ip address" prop="ip">
							<el-input class="list_inp" v-model="form.ip" placeholder="ip address"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Request parameters" prop="params">
							<el-input v-model="form.params" placeholder="Request parameters" type="textarea"
