	...
	<div>
		<el-dialog modal-class="edit_form_modal" class="edit_form" v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" :rules="rules">
				<el-row >
					<el-col :span="24">
						<el-form-item label="Nme" prop="name">
							<el-input class="list_inp" v-model="form.name" placeholder="Name"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Recommend Type" prop="inteltype">
							<el-input class="list_inp" v-model="form.inteltype" placeholder="Recommend Type"
                                type="text"
					...
					<el-col :span="24">
						<el-form-item label="Remark" prop="remark">
							<el-input class="list_inp" v-model="form.remark" placeholder="Remark"
                                type="text"
