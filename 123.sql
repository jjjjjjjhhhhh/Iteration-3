...
MySQL - 8.0.12 : Database - cl0184941100
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`cl0184941100` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
(5,'2025-05-08 20:32:33',5,'提问内容5','回复内容5',5,5),
(6,'2025-05-08 20:32:33',6,'提问内容6','回复内容6',6,6),
...
insert  into `chat_friend`(`id`,`addtime`,`uid`,`fid`,`name`,`picture`,`role`,`tablename`,`alias`,`type`) values 
(1,'2025-05-08 20:32:33',1,1,'名称1','file/chat_friendPicture1.jpg,file/chat_friendPicture2.jpg,file/chat_friendPicture3.jpg','角色1','表名1','别名1',1),
(2,'2025-05-08 20:32:33',2,2,'名称2','file/chat_friendPicture2.jpg,file/chat_friendPicture3.jpg,file/chat_friendPicture4.jpg','角色2','表名2','别名2',2),
(3,'2025-05-08 20:32:33',3,3,'名称3','file/chat_friendPicture3.jpg,file/chat_friendPicture4.jpg,file/chat_friendPicture5.jpg','角色3','表名3','别名3',3),
(4,'2025-05-08 20:32:33',4,4,'名称4','file/chat_friendPicture4.jpg,file/chat_friendPicture5.jpg,file/chat_friendPicture6.jpg','角色4','表名4','别名4',4),
(5,'2025-05-08 20:32:33',5,5,'名称5','file/chat_friendPicture5.jpg,file/chat_friendPicture6.jpg,file/chat_friendPicture7.jpg','角色5','表名5','别名5',5),
(6,'2025-05-08 20:32:33',6,6,'名称6','file/chat_friendPicture6.jpg,file/chat_friendPicture7.jpg,file/chat_friendPicture8.jpg','角色6','表名6','别名6',6),
...
insert  into `chat_message`(`id`,`addtime`,`uid`,`fid`,`content`,`format`,`is_read`) values 
(1,'2025-05-08 20:32:33',1,1,'内容1',1,1),
(2,'2025-05-08 20:32:33',2,2,'内容2',2,2),
(3,'2025-05-08 20:32:33',3,3,'内容3',3,3),
(4,'2025-05-08 20:32:33',4,4,'内容4',4,4),
(5,'2025-05-08 20:32:33',5,5,'内容5',5,5),
(6,'2025-05-08 20:32:33',6,6,'内容6',6,6),
...
insert  into `config`(`id`,`addtime`,`name`,`value`,`url`) values 
(1,'2025-05-08 20:32:34','swiper1','file/swiperPicture1.jpg',NULL),
(2,'2025-05-08 20:32:34','swiper2','file/swiperPicture2.jpg',NULL),
(3,'2025-05-08 20:32:34','swiper3','file/swiperPicture3.jpg',NULL);
...
CREATE TABLE `jiankangdangan` (
  ...
  `nianling` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '年龄',
  `shengao` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '身高',
  `tizhong` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '体重',
  `xuexing` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '血型',
  `jiwangbingshi` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '既往病史',
...
insert  into `jiankangdangan`(`id`,`addtime`,`yonghuzhanghao`,`yonghuxingming`,`xingbie`,`touxiang`,`chushengriqi`,`nianling`,`shengao`,`tizhong`,`xuexing`,`jiwangbingshi`,`jiazubingshi`,`guominyaowu`) values 
(1,'2025-05-08 20:32:33','用户账号1','用户姓名1','性别1','file/jiankangdanganTouxiang1.jpg,file/jiankangdanganTouxiang2.jpg,file/jiankangdanganTouxiang3.jpg','2025-05-08','年龄1','身高1','体重1','血型1','既往病史1','小儿麻痹','过敏药物1'),
(2,'2025-05-08 20:32:33','用户账号2','用户姓名2','性别2','file/jiankangdanganTouxiang2.jpg,file/jiankangdanganTouxiang3.jpg,file/jiankangdanganTouxiang4.jpg','2025-05-08','年龄2','身高2','体重2','血型2','既往病史2','家族病史2','过敏药物2'),
(3,'2025-05-08 20:32:33','用户账号3','用户姓名3','性别3','file/jiankangdanganTouxiang3.jpg,file/jiankangdanganTouxiang4.jpg,file/jiankangdanganTouxiang5.jpg','2025-05-08','年龄3','身高3','体重3','血型3','既往病史3','冠心病','过敏药物3'),
(4,'2025-05-08 20:32:33','用户账号4','用户姓名4','性别4','file/jiankangdanganTouxiang4.jpg,file/jiankangdanganTouxiang5.jpg,file/jiankangdanganTouxiang6.jpg','2025-05-08','年龄4','身高4','体重4','血型4','既往病史4','家族病史4','过敏药物4'),
(5,'2025-05-08 20:32:33','用户账号5','用户姓名5','性别5','file/jiankangdanganTouxiang5.jpg,file/jiankangdanganTouxiang6.jpg,file/jiankangdanganTouxiang7.jpg','2025-05-08','年龄5','身高5','体重5','血型5','既往病史5','家族病史5','过敏药物5'),
(6,'2025-05-08 20:32:33','用户账号6','用户姓名6','性别6','file/jiankangdanganTouxiang6.jpg,file/jiankangdanganTouxiang7.jpg,file/jiankangdanganTouxiang8.jpg','2025-05-08','年龄6','身高6','体重6','血型6','既往病史6','家族病史6','过敏药物6'),
(7,'2025-05-08 20:32:33','用户账号7','用户姓名7','性别7','file/jiankangdanganTouxiang7.jpg,file/jiankangdanganTouxiang8.jpg,file/jiankangdanganTouxiang9.jpg','2025-05-08','年龄7','身高7','体重7','血型7','既往病史7','家族病史7','过敏药物7'),
(8,'2025-05-08 20:32:33','用户账号8','用户姓名8','性别8','file/jiankangdanganTouxiang8.jpg,file/jiankangdanganTouxiang9.jpg,file/jiankangdanganTouxiang10.jpg','2025-05-08','年龄8','身高8','体重8','血型8','既往病史8','家族病史8','过敏药物8'),
(9,'2025-05-08 20:32:33','用户账号9','用户姓名9','性别9','file/jiankangdanganTouxiang9.jpg,file/jiankangdanganTouxiang10.jpg,file/jiankangdanganTouxiang11.jpg','2025-05-08','年龄9','身高9','体重9','血型9','既往病史9','家族病史9','过敏药物9'),
(10,'2025-05-08 20:32:33','用户账号10','用户姓名10','性别10','file/jiankangdanganTouxiang10.jpg,file/jiankangdanganTouxiang11.jpg,file/jiankangdanganTouxiang12.jpg','2025-05-08','年龄10','身高10','体重10','血型10','既往病史10','家族病史10','过敏药物10');
...
CREATE TABLE `jiankangmubiao` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `mubiaotizhong` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标体重',
  `mubiaoxinlv` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标心率',
  `mubiaoxueya` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '目标血压',
  `jihua` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '计划',
  `yonghuzhanghao` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户账号',
  `yonghuxingming` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户姓名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='健康目标';

/*Data for the table `jiankangmubiao` */

insert  into `jiankangmubiao`(`id`,`addtime`,`mubiaotizhong`,`mubiaoxinlv`,`mubiaoxueya`,`jihua`,`yonghuzhanghao`,`yonghuxingming`) values 
(1,'2025-05-08 20:32:33','目标体重1','目标心率1','目标血压1','计划1','用户账号1','用户姓名1'),
(2,'2025-05-08 20:32:33','目标体重2','目标心率2','目标血压2','计划2','用户账号2','用户姓名2'),
(3,'2025-05-08 20:32:33','目标体重3','目标心率3','目标血压3','计划3','用户账号3','用户姓名3'),
(4,'2025-05-08 20:32:33','目标体重4','目标心率4','目标血压4','计划4','用户账号4','用户姓名4'),
(5,'2025-05-08 20:32:33','目标体重5','目标心率5','目标血压5','计划5','用户账号5','用户姓名5'),
...
CREATE TABLE `jiankangshipu` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `shipumingcheng` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '食谱名称',
  `fengmian` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '封面',
  `suoxushicai` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '所需食材',
  `shipugongxiao` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '食谱功效',
  `shiherenqun` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '适合人群',
  `zhizuofangfa` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '制作方法',
...
(6,'2025-05-08 20:32:33','食谱名称6','file/jiankangshipuFengmian6.jpg,file/jiankangshipuFengmian7.jpg,file/jiankangshipuFengmian8.jpg','所需食材6','食谱功效6','适合人群6','制作方法6','2025-05-08 20:32:33','详情简介6',6,6,6,6,'2025-05-08 20:32:33'),
(7,'2025-05-08 20:32:33','食谱名称7','file/jiankangshipuFengmian7.jpg,file/jiankangshipuFengmian8.jpg,file/jiankangshipuFengmian9.jpg','所需食材7','食谱功效7','适合人群7','制作方法7','2025-05-08 20:32:33','详情简介7',7,7,7,7,'2025-05-08 20:32:33'),
(8,'2025-05-08 20:32:33','食谱名称8','file/jiankangshipuFengmian8.jpg,file/jiankangshipuFengmian9.jpg,file/jiankangshipuFengmian10.jpg','所需食材8','食谱功效8','适合人群8','制作方法8','2025-05-08 20:32:33','详情简介8',8,8,8,8,'2025-05-08 20:32:33'),
(9,'2025-05-08 20:32:33','食谱名称9','file/jiankangshipuFengmian9.jpg,file/jiankangshipuFengmian10.jpg,file/jiankangshipuFengmian11.jpg','所需食材9','食谱功效9','适合人群9','制作方法9','2025-05-08 20:32:33','详情简介9',9,9,9,9,'2025-05-08 20:32:33'),
(10,'2025-05-08 20:32:33','食谱名称10','file/jiankangshipuFengmian10.jpg,file/jiankangshipuFengmian11.jpg,file/jiankangshipuFengmian12.jpg','所需食材10','食谱功效10','适合人群10','制作方法10','2025-05-08 20:32:33','详情简介10',10,10,10,10,'2025-05-08 20:32:33');
...
CREATE TABLE `jiankangshuju` (
  ...
  `tizhong` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '体重',
  `xueya` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '血压',
  `xuetang` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '血糖',
  `xinlv` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '心率',
...
(5,'2025-05-08 20:32:33','2025-05-08','用户账号5','用户姓名5','file/jiankangshujuTouxiang5.jpg,file/jiankangshujuTouxiang6.jpg,file/jiankangshujuTouxiang7.jpg','性别5','体重5','血压5','血糖5','心率5','胆固醇5','睡眠质量5'),
(6,'2025-05-08 20:32:33','2025-05-08','用户账号6','用户姓名6','file/jiankangshujuTouxiang6.jpg,file/jiankangshujuTouxiang7.jpg,file/jiankangshujuTouxiang8.jpg','性别6','体重6','血压6','血糖6','心率6','胆固醇6','睡眠质量6'),
...
CREATE TABLE `jiankangzhishi` (
  ...
  `jianjie` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '简介',
  `tupian` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '图片',
  `neirong` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '内容',
...
CREATE TABLE `jiankangzhuanjia` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `zhuanjiazhanghao` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '专家账号',
  `zhuanjiamima` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '专家密码',
  `zhuanjiaxingming` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '专家姓名',
  `touxiang` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '头像',
  `xingbie` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '性别',
  `nianling` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '年龄',
  `shanzhanglingyu` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '擅长领域',
  `gerenjianjie` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '个人简介',
  PRIMARY KEY (`id`),
...
(195,'2025-05-08 20:32:33','专家账号5','e10adc3949ba59abbe56e057f20f883e','专家姓名5','file/jiankangzhuanjiaTouxiang5.jpg','男','年龄5','擅长领域5','个人简介5'),
(196,'2025-05-08 20:32:33','专家账号6','e10adc3949ba59abbe56e057f20f883e','专家姓名6','file/jiankangzhuanjiaTouxiang6.jpg','男','年龄6','擅长领域6','个人简介6'),
(197,'2025-05-08 20:32:33','专家账号7','e10adc3949ba59abbe56e057f20f883e','专家姓名7','file/jiankangzhuanjiaTouxiang7.jpg','男','年龄7','擅长领域7','个人简介7'),
(198,'2025-05-08 20:32:33','专家账号8','e10adc3949ba59abbe56e057f20f883e','专家姓名8','file/jiankangzhuanjiaTouxiang8.jpg','男','年龄8','擅长领域8','个人简介8'),
(199,'2025-05-08 20:32:33','专家账号9','e10adc3949ba59abbe56e057f20f883e','专家姓名9','file/jiankangzhuanjiaTouxiang9.jpg','男','年龄9','擅长领域9','个人简介9'),
(200,'2025-05-08 20:32:33','专家账号10','e10adc3949ba59abbe56e057f20f883e','专家姓名10','file/jiankangzhuanjiaTouxiang10.jpg','男','年龄10','擅长领域10','个人简介10');
...
CREATE TABLE `jianshenjihua` (
  ...
  `jihuaneirong` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计划内容',
...
insert  into `jianshenjihua`(`id`,`addtime`,`yonghuzhanghao`,`yonghuxingming`,`jihuabiaoti`,`kaishiriqi`,`jieshuriqi`,`jihuaneirong`,`jihuashijian`,`beizhu`) values 
(1,'2025-05-08 20:32:33','用户账号1','用户姓名1','计划标题1','2025-05-08','2025-05-08','计划内容1','2025-05-08 20:32:33','备注1'),
(2,'2025-05-08 20:32:33','用户账号2','用户姓名2','计划标题2','2025-05-08','2025-05-08','计划内容2','2025-05-08 20:32:33','备注2'),
(3,'2025-05-08 20:32:33','用户账号3','用户姓名3','计划标题3','2025-05-08','2025-05-08','计划内容3','2025-05-08 20:32:33','备注3'),
(4,'2025-05-08 20:32:33','用户账号4','用户姓名4','计划标题4','2025-05-08','2025-05-08','计划内容4','2025-05-08 20:32:33','备注4'),
(5,'2025-05-08 20:32:33','用户账号5','用户姓名5','计划标题5','2025-05-08','2025-05-08','计划内容5','2025-05-08 20:32:33','备注5'),
(6,'2025-05-08 20:32:33','用户账号6','用户姓名6','计划标题6','2025-05-08','2025-05-08','计划内容6','2025-05-08 20:32:33','备注6'),
(7,'2025-05-08 20:32:33','用户账号7','用户姓名7','计划标题7','2025-05-08','2025-05-08','计划内容7','2025-05-08 20:32:33','备注7'),
(8,'2025-05-08 20:32:33','用户账号8','用户姓名8','计划标题8','2025-05-08','2025-05-08','计划内容8','2025-05-08 20:32:33','备注8'),
(9,'2025-05-08 20:32:33','用户账号9','用户姓名9','计划标题9','2025-05-08','2025-05-08','计划内容9','2025-05-08 20:32:33','备注9'),
(10,'2025-05-08 20:32:33','用户账号10','用户姓名10','计划标题10','2025-05-08','2025-05-08','计划内容10','2025-05-08 20:32:33','备注10');
...
CREATE TABLE `jiatingchengyuan` (
  ...
  `relationship` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关系',
...
CREATE TABLE `online_message` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '姓名',
...
insert  into `online_message`(`id`,`addtime`,`name`,`phone`,`content`) values 
(1,'2025-05-08 20:32:33','姓名1','电话1','留言内容1'),
(2,'2025-05-08 20:32:33','姓名2','电话2','留言内容2'),
(3,'2025-05-08 20:32:33','姓名3','电话3','留言内容3'),
(4,'2025-05-08 20:32:33','姓名4','电话4','留言内容4'),
(5,'2025-05-08 20:32:33','姓名5','电话5','留言内容5'),
(6,'2025-05-08 20:32:33','姓名6','电话6','留言内容6'),
...
CREATE TABLE `popup_remind` (
  ...
  `title` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标题',
  `type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '私人' COMMENT '类型',
...
insert  into `popup_remind`(`id`,`addtime`,`userid`,`title`,`type`,`brief`,`content`,`remind_time`) values 
(1,'2025-05-08 20:32:33',1,'标题1','私人','简介1','内容1','2025-05-08 20:32:33'),
(2,'2025-05-08 20:32:33',2,'标题2','私人','简介2','内容2','2025-05-08 20:32:33'),
(3,'2025-05-08 20:32:33',3,'标题3','私人','简介3','内容3','2025-05-08 20:32:33'),
(4,'2025-05-08 20:32:33',4,'标题4','私人','简介4','内容4','2025-05-08 20:32:33'),
(5,'2025-05-08 20:32:33',5,'标题5','私人','简介5','内容5','2025-05-08 20:32:33'),
(6,'2025-05-08 20:32:33',6,'标题6','私人','简介6','内容6','2025-05-08 20:32:33'),
...
insert  into `users`(`id`,`addtime`,`username`,`password`,`role`) values 
(1,'2025-05-08 20:32:34','admin','admin','管理员');
...
CREATE TABLE `yinshijilu` (
  ...
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `jiluriqi` date DEFAULT NULL COMMENT '记录日期',
  `yinshixiangqing` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '饮食详情',
  `yonghuzhanghao` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户账号',
  `yonghuxingming` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用户姓名',
  PRIMARY KEY (`id`)
...
(5,'2025-05-08 20:32:33','2025-05-08','饮食详情5','用户账号5','用户姓名5'),
(6,'2025-05-08 20:32:33','2025-05-08','饮食详情6','用户账号6','用户姓名6'),
...
CREATE TABLE `yongyaoguanli` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `yaopinmingcheng` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '药品名称',
  `guige` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '规格',
  `fuyongjiliang` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '服用剂量',
  `meirifuyongcishu` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '每日服用次数',
...
/*Data for the table `yongyaoguanli` */

insert  into `yongyaoguanli`(`id`,`addtime`,`yaopinmingcheng`,`guige`,`fuyongjiliang`,`meirifuyongcishu`,`qishifuyongshijian`,`yujijieshushijian`,`yonghuzhanghao`,`yonghuxingming`) values 
(1,'2025-05-08 20:32:33','药品名称1','规格1','服用剂量1','每日服用次数1','2025-05-08','2025-05-08','用户账号1','用户姓名1'),
(2,'2025-05-08 20:32:33','药品名称2','规格2','服用剂量2','每日服用次数2','2025-05-08','2025-05-08','用户账号2','用户姓名2'),
(3,'2025-05-08 20:32:33','药品名称3','规格3','服用剂量3','每日服用次数3','2025-05-08','2025-05-08','用户账号3','用户姓名3'),
(4,'2025-05-08 20:32:33','药品名称4','规格4','服用剂量4','每日服用次数4','2025-05-08','2025-05-08','用户账号4','用户姓名4'),
(5,'2025-05-08 20:32:33','药品名称5','规格5','服用剂量5','每日服用次数5','2025-05-08','2025-05-08','用户账号5','用户姓名5'),
(6,'2025-05-08 20:32:33','药品名称6','规格6','服用剂量6','每日服用次数6','2025-05-08','2025-05-08','用户账号6','用户姓名6'),
