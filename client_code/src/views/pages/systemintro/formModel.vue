	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">Title</div>
					<div  class="info_text" >{{detail.title}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Subtitle</div>
					<div  class="info_text" >{{detail.subtitle}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('systemintro','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('systemintro','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
