			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="Target Heart Rate" prop="mubiaoxinlv">
						<el-input class="list_inp"
                                  v-model="form.mubiaoxinlv"
                                  placeholder="Target Heart Rate"
                                  type="text"
				...
				<el-col :span="12">
					<el-form-item label="Target Blood Pressure" prop="mubiaoxueya">
						<el-input class="list_inp"
                                  v-model="form.mubiaoxueya"
                                  placeholder="Target Blood Pressure"
                                  type="text"
				...
				<el-col :span="24">
					<el-form-item label="Plan" prop="jihua">
						<editor class="list_editor" :value="form.jihua" placeholder="Please enter plan" :readonly="!isAdd||disabledForm.jihua?true:false"
							@change="(e)=>editorChange(e,'jihua')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jihua = res.data.data.jihua.replace(reg,'../../../cl0184941100/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		context?.$http({
			...
			if(json.hasOwnProperty('yonghuzhanghao') && context?.$toolUtil.storageGet("frontRole")!="Administrator"){
				form.value.yonghuzhanghao = json.yonghuzhanghao
				disabledForm.value.yonghuzhanghao = true;
			}
			if(json.hasOwnProperty('yonghuxingming') && context?.$toolUtil.storageGet("frontRole")!="Administrator"){
