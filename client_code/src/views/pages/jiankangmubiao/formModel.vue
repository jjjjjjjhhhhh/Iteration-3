			...
			<div class="info_view">
				<div class="title_view">
					<div class="detail_title">
						<span>{{detail.mubiaotizhong}}</span>
					</div>
				</div>
				<div class="info_item">
					<div class="info_label">Target Heart Rate</div>
					<div  class="info_text" >{{detail.mubiaoxinlv}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Target Blood Pressure</div>
					<div  class="info_text" >{{detail.mubiaoxueya}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiankangmubiao','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiankangmubiao','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
		<div class="detail-box">
			<div class="title"><span>Plan</span></div>
			<div class="content" v-html="detail.jihua"></div>
		</div>
	</div>
</template>
<script setup>
	...
	const getDetail = () => {
		context?.$http({
            ...
            title.value = res.data.data.mubiaotizhong
