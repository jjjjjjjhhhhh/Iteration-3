		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			<div class="search_view">
				...
				<div class="search_box">
					<el-input class="search_inp" v-model="searchQuery.yonghuxingming" placeholder="User Name"
						clearable>
					</el-input>
				</div>
			</div>
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('jiankangmubiao','新增')" @click="addClick">Add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="Target Weight" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.mubiaotizhong}}
							</template>
						</el-table-column>
						<el-table-column label="Target Heart Rate" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.mubiaoxinlv}}
							</template>
						</el-table-column>
						<el-table-column label="Target Blood Pressure" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.mubiaoxueya}}
							</template>
						</el-table-column>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/jiankangmubiaoAdd')
	}
	//判断是否从个人中心跳转
