	...
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="User Operation" prop="operation">
						<el-input class="list_inp"
                                  v-model="form.operation"
                                  placeholder="User Operation"
                                  type="text"
				...
				<el-col :span="12">
					<el-form-item label="Request Duration(ms)" prop="time">
						<el-input class="list_inp"
                                  v-model="form.time"
                                  placeholder="Request Duration(ms)"
                                  type="text"
