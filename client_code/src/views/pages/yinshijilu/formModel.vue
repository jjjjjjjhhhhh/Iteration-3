	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('yinshijilu','修改')" type="primary" @click="editClick">modify</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('yinshijilu','删除')" type="danger" @click="delClick">delete</el-button>
				</div>
			</div>
		</div>
		<div class="detail-box">
			<div class="title"><span>Dietary Details</span></div>
			<div class="content" v-html="detail.yinshixiangqing"></div>
		</div>
	</div>
</template>
<script setup>
