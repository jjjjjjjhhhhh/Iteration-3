			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="Dietary Details" prop="yinshixiangqing">
						<editor class="list_editor" :value="form.yinshixiangqing" placeholder="Please enter dietary details" :readonly="!isAdd||disabledForm.yinshixiangqing?true:false"
							@change="(e)=>editorChange(e,'yinshixiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.yinshixiangqing = res.data.data.yinshixiangqing.replace(reg,'../../../cl0184941100/file');
