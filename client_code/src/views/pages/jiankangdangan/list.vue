	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('jiankangdangan','新增')" @click="addClick">Add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="Date of Birth" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.chushengriqi}}
							</template>
						</el-table-column>
						<el-table-column label="Age" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.nianling}}
							</template>
						</el-table-column>
						<el-table-column label="Height" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.shengao}}
							</template>
						</el-table-column>
						...
						<el-table-column label="Blood Type" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.xuexing}}
							</template>
						</el-table-column>
						<el-table-column label="Allergic Drugs" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.guominyaowu}}
							</template>
						</el-table-column>
					</el-table>
                </div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/jiankangdanganAdd')
	}
	//判断是否从个人中心跳转
