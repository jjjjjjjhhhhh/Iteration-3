	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('yonghu','新增')" @click="addClick">Add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="Password" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.yonghumima}}
							</template>
						</el-table-column>
						...
						<el-table-column label="Icon" :resizable='true' align="left" header-align="left">
							<template #default="scope">
						...
						<el-table-column label="phone number" :resizable='true' align="left" header-align="left">
							<template #default="scope">
