		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			<div class="search_view">
				...
				<div class="search_box">
					<el-input class="search_inp" v-model="searchQuery.zhuanjiaxingming" placeholder="Expert Name"
						clearable>
					</el-input>
				</div>
			</div>
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('jiankangzhuanjia','新增')" @click="addClick">Add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
					...
					<div class="data_item" v-for="(item,index) in list" :key="index" @click.stop="detailClick(item.id)" >
						...
						<div class="data_content">
							<div class="data_title1">
								<span>{{item.zhuanjiaxingming}}</span>
							</div>
						</div>
					</div>
				</div>
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/jiankangzhuanjiaAdd')
	}
	//判断是否从个人中心跳转
