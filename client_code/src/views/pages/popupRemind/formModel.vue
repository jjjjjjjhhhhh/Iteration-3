	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">Type</div>
					<div  class="info_text" >{{detail.type}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Brief</div>
					<div  class="info_text" >{{detail.brief}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Remind Time</div>
					<div  class="info_text" >{{detail.remindTime}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('popup_remind','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('popup_remind','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
...
<script setup>
	...
	const formName = 'Medicine Reminder'
	//基础信息
	const breadList = ref([{
		name: formName
	}])
