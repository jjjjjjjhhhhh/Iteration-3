	...
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="Reminder time" prop="remindTime">
						<el-date-picker
							class="list_date"
							...
							placeholder="Please select a reminder time" />
					</el-form-item>
				</el-col>
				<el-col :span="24">
					<el-form-item label="brief introduction" prop="brief">
						<el-input v-model="form.brief" placeholder="brief introduction" type="textarea"
				...
				<el-col :span="24">
					<el-form-item label="content" prop="content">
						<editor class="list_editor" :value="form.content" placeholder="Please enter the content" :readonly="!isAdd||disabledForm.content?true:false"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.content = res.data.data.content.replace(reg,'../../../cl0184941100/file');
