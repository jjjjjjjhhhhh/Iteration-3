<template>
	<div class="edit_view" :style='{}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="12">
					<el-form-item label="Title" prop="biaoti">
				...
				<el-col :span="24">
					<el-form-item label="Introduction" prop="jianjie">
						<el-input v-model="form.jianjie" placeholder="Introduction" type="textarea"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.neirong = res.data.data.neirong.replace(reg,'../../../cl0184941100/file');
