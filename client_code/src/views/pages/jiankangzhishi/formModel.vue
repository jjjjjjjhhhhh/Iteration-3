	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">Introduction</div>
				...
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiankangzhishi','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiankangzhishi','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
...
<script setup>
    ...
    const commentDel = (item)=>{
        context.$confirm("Are you sure you want to delete this comment?","Tip").then(()=>{
