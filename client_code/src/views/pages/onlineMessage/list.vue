	...
	<div class="list-page" :style='{}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search" @submit.native.prevent>
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('online_message','新增')" @click="addClick">Add</el-button>
			</div>
		</el-form>
		<div class="page_list">
			<div class="data_box">
...
<script setup>
	...
	const addClick = () => {
		router.push('/index/onlineMessageAdd')
	}
	//判断是否从个人中心跳转
