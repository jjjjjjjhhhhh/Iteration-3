		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.phone}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Message Content</div>
					<div  class="info_text" >{{detail.content}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('online_message','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('online_message','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
	</div>
