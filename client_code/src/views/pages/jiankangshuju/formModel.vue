	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">Blood Pressure</div>
					<div  class="info_text" >{{detail.xueya}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Blood Sugar</div>
					<div  class="info_text" >{{detail.xuetang}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Heart Rate</div>
					<div  class="info_text" >{{detail.xinlv}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Cholesterol</div>
					<div  class="info_text" >{{detail.danguchun}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">Sleep Quality</div>
					<div  class="info_text" >{{detail.shuimianzhiliang}}</div>
				</div>
				<div class="btn_view">
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiankangshuju','修改')" type="primary" @click="editClick">Edit</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiankangshuju','删除')" type="danger" @click="delClick">Delete</el-button>
				</div>
			</div>
		</div>
	</div>
...
<script setup>
	...
	const getDetail = () => {
		context?.$http({
            ...
            title.value = res.data.data.jiluriqi
