	...
	validator: {
		...
		number: (rule, value, callback) => {
			if (!value) {
				...
				callback(new Error("Please enter an number"));
			} else {
				callback();
			}
		},
		...
		email: (rule, value, callback) => {
			if (!value) {
				...
				callback(new Error("Please enter right email"));
			} else {
				callback();
			}
		},
		...
		idCard: (rule, value, callback) => {
			if (!value) {
				...
				callback(new Error("Please enter right id number"));
			} else {
				callback();
			}
		},
		...
		url: (rule, value, callback) => {
			if (!value) {
				...
				callback(new Error("Please enter right url"));
			} else {
				callback();
			}
		},
		richText: (rule, value, callback) => {
			if (!value) {
				...
				if (/[^(<p>|</p>|<br>|\s)]/.test(value)) {
					...
					callback(new Error("Please enteer"));
				}
			}
		}
	},
